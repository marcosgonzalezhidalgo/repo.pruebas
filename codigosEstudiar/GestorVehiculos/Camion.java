...
public class Camion extends Vehiculo {
    public static final String[] MARCAS_DISPONIBLES = {"Volvo", "Scania", "Mercedes-Benz", "MAN", "Iveco"};
    public static final String[] TIPOS_DISPONIBLES = {"Camión ligero", "Camión mediano", "Camión pesado", "Camión de carga", "Camión de reparto"};
    public static final String[] AÑOS_DISPONIBLES = {"2001", "2005", "2010", "2015", "2020"};
    
    public Camion(String marca, String tipo, String año, String color) {
        super(marca, tipo, año, color);
    }

    public static void mostrarOpciones() {
        System.out.println("Opciones de Camión:");
