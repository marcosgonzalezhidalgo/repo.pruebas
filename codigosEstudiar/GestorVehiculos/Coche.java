...
public class Coche extends Vehiculo{
    public static final String[] MARCAS_DISPONIBLES = {"Toyota", "Ford", "BMW", "Renault", "Honda"};
    public static final String[] TIPOS_DISPONIBLES = {"Coupé", "Sedán", "SUV", "Hatchback", "Convertible"};
    public static final String[] AÑOS_DISPONIBLES = {"2001", "2005", "2010", "2015", "2020"};

    public Coche(String marca, String tipo, String año, String color) {
